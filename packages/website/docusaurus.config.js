    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/es-maintenance/package-inspector/packages/website',
        },
        theme: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} es-maintenace. Built with Docusaurus.`,
      },
      prism: {
